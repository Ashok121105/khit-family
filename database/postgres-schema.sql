...
CREATE TABLE IF NOT EXISTS store_inventory (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    material_id BIGINT NOT NULL UNIQUE REFERENCES store_materials(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS store_distributions (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    material_id BIGINT NOT NULL REFERENCES store_materials(id) ON DELETE CASCADE,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_store_materials_academic_scope ON store_materials(academic_year, department, year, semester);
CREATE INDEX IF NOT EXISTS idx_store_materials_subject ON store_materials(subject_id);
CREATE INDEX IF NOT EXISTS idx_store_materials_faculty ON store_materials(faculty_id);
CREATE INDEX IF NOT EXISTS idx_store_materials_status ON store_materials(status);
CREATE INDEX IF NOT EXISTS idx_store_inventory_material ON store_inventory(material_id);
CREATE INDEX IF NOT EXISTS idx_store_distributions_material_status ON store_distributions(material_id, status);
CREATE INDEX IF NOT EXISTS idx_store_distributions_student_status ON store_distributions(student_id, status);
CREATE INDEX IF NOT EXISTS idx_store_distributions_collected_at ON store_distributions(collected_at);
